                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box" style="background: white;">
                            <a href="{{ route('admin_dashboard') }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/images/company-logo-3x.png') }}" alt="" height="40">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/company-logo-3x.png') }}" alt="" height="75">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item d-block" href="{{ route('admin_settings') }}"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Settings</span></a>
